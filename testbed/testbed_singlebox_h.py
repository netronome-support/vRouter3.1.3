...
env.ns_agilio_vrouter = {
    h: {'huge_page_alloc': '24G', 'huge_page_size': '1G', 'coremask': '2,4', 'pinning_mode': 'auto:split'}
}
...
#}
bond= {
    h : { 'name': 'bond0', 'member': ['nfp_p0','nfp_p1','nfp_p2','nfp_p3'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
}
...
#}
control_data = {
    h : { 'ip': '10.0.0.50/28', 'gw' : '10.0.0.10', 'device':'bond0' },
}
...
# env.dpdk = {
     #h: { 'huge_pages' : '50', 'coremask' : '0xf', 'uio_driver' : 'uio_pci_generic' },

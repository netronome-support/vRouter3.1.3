...
r730_dev_02 = 'root@r730-dev-02.vrt.netronome.com'
...
env.roledefs = {
    'all': [r730_dev_02],
    'cfgm': [r730_dev_02],
    'openstack': [r730_dev_02],
    'control': [r730_dev_02],
    'compute': [r730_dev_02],
    'collector': [r730_dev_02],
    'webui': [r730_dev_02],
    'database': [r730_dev_02],
    'build': [host_build],
    'storage-master': [r730_dev_02],
    'storage-compute': [r730_dev_02],
    ...
    # 'rally': [r730_dev_01], # Optional, to enable/setup rally, it can be a seprate node from contrail cluster
    # 'vgw': [r730_dev_01], # Optional, Only to enable VGW. Only compute can support vgw
    # 'tsn': [r730_dev_01], # Optional, Only to enable TSN. Only compute can support TSN
    # 'toragent': [r730_dev_01], Optional, Only to enable Tor Agent. Only compute can
    # support Tor Agent
...
#Inferface Bonding
#bond= {
#    r730_dev_01 : { 'name': 'bond0', 'member': ['p2p0p0','p2p0p1','p2p0p2','p2p0p3'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
#}

#OPTIONAL SEPARATION OF MANAGEMENT AND CONTROL + DATA and OPTIONAL VLAN INFORMATION
#==================================================================================
#control_data = {
#    r730_dev_01 : { 'ip': '192.168.10.1/24', 'gw' : '192.168.10.254', 'device': 'bond0', 'vlan': '224' },
#}

#OPTIONAL STATIC ROUTE CONFIGURATION
#===================================
#static_route  = {
#    r730_dev_01 : [{ 'ip': '10.1.1.0', 'netmask' : '255.255.255.0', 'gw':'192.168.10.254', 'intf': 'bond0' },
#             { 'ip': '10.1.2.0', 'netmask' : '255.255.255.0', 'gw':'192.168.10.254', 'intf': 'bond0' }],
#}

#storage compute disk config
#storage_node_config = {
#    r730_dev_01 : { 'disks' : ['sdc', 'sdd'] },
#}
...
#env.vgw = {r730_dev_01: {'vgw1':{'vn':'default-domain:admin:public:public', 'ipam-subnets': ['10.204.220.128/29', '10.204.220.136/29', 'gateway-routes': ['8.8.8.0/24', '1.1.1.0/24']}]},
...
#env.qos = {r730_dev_01: [ {'hardware_q_id': '3', 'logical_queue':['1', '6-10', '12-15']},
...
# env.dpdk = {
#     r730_dev_01: { 'huge_pages' : '50', 'coremask' : '0xf', 'uio_driver' : 'uio_pci_generic' },
...
#     r730_dev_01:{'flow_entries':'4000000', 'mpls_labels':'131072', 'nexthops':'131072','vrfs':'65536','macs':'262144'},
#}
